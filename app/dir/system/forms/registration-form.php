          ...
          <div class="card-body shadow">
            ...
            <form class="" action="" method="POST">
              <div class="mb-3" align="center">
                <h4>Registration</h4>
                <small>Already have an account? <a class="text-decoration-none" href="/system/view/access/">Sign in</a></small><br>
                <hr class="mb-4">
              </div>
              ...
              <div class="form-group mb-1" align="center">
                <small><p>
                  By creating an account, you agree to our <a class="text-decoration-none" href="/system/view//privacy-policy/">Privacy Policy</a> and <a class="text-decoration-none" href="/system/view/terms/">Terms of Use</a>.
                </p></small>
