...
$user_fname = mysqli_real_escape_string($con, $_POST['delete_fname']);
$user_lname = mysqli_real_escape_string($con, $_POST['delete_lname']);
...
if($background_image['filename'] !== "default-background.jpg"){
  ...
  unlink('../../../img/background/'.$background_image['filename']);
