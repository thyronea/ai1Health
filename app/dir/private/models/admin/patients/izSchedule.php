...
if(isset($_GET['patientID'])){
      ...
      $rsv_message = "
        ...
        $rsv_schedule = "
          <div style='margin-top: 5px;'>
            ...
            <button id='btn_complete' class='px-2 btn btn-sm border rounded-3' style='cursor:default'><small>$rsv1</small></button>
          </div>
        ";  
    }
    ...
    $flu_req = "SELECT * FROM immunization WHERE patientID='$patientID' AND type='Influenza' ORDER BY id DESC";
    $flu_req_run = mysqli_query($con, $flu_req);
    if(mysqli_num_rows($flu_req_run) == 0){
     $flu_message = "
     <small><a href='https://www.cdc.gov/vaccines/schedules/hcp/imz/child-adolescent.html' target='_blank'>Immunization Schedule</a></small><br>
     <button type='button' class='focus-ring btn btn-sm border mt-5 mb-3 shadow' id='submit_btn' data-bs-toggle='modal' data-bs-target='#administer_flu'>Administer Influenza</button> 
      ";
    }
    if(mysqli_num_rows($flu_req_run) > 0){
      $flu_message = "
         <div align='center'>
            <small>
             <div class='mb-3'>
              ...
              <button type='button' class='focus-ring btn btn-sm border mt-3 shadow' id='submit_btn' data-bs-toggle='modal' data-bs-target='#administer_covid'>Administer Influenza</button> 
            </small>
          </div>
      ";
    }
