    ...
    <div class="row g-2">
      ...
      <div class="col dropdown mt-2">
        ...
        <ul class="dropdown-menu" style="font-size: 12px;">
          ...
          <li ><a class="dropdown-item focus-ring" href="../../admin/profile/index.php?userID=<?=$_SESSION['userID'];?>" target="_blank"><small><?=htmlspecialchars($_SESSION['fname']); ?> <?=htmlspecialchars($_SESSION['lname']); ?></small></a></li>
          <li><hr class="dropdown-divider" /></li>
    ...
    <nav class="navbar bg-body-tertiary">
      <div class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <!--Patients-->
          <li data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Patients" class="nav-item" role="presentation">
            <a class="nav-link" <a style="color: black; text-decoration: none;" href="page/patients/index.php">
          ...
          <li data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Inventory" class="nav-item" role="presentation">
            <a class="nav-link" style="color: black; text-decoration: none;" href="page/inventory/index.php">
          ...
          <li data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Storage & Handling" class="nav-item" role="presentation">
            <a class="nav-link" style="color: black; text-decoration: none;" href="page/temperature/index.php">
          ...
          <li data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Document" class="nav-item" role="presentation">
            <form method="post">
              <a class="nav-link" style="color: black; text-decoration: none;" href="page/docs/index.php">
          ...
          <li data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Manager" class="nav-item" role="presentation">
            <form method="post">
              <a class="nav-link" style="color: black; text-decoration: none;" href="page/manager/index.php">
