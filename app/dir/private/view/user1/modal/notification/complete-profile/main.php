<div class="modal fade" id="addProfile" tabindex="-1" data-bs-backdrop="static" aria-labelledby="addProfile-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">

      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="addProfile-ModalLabel">Complete Profile</h1>
      </div>

      <form action="modal/notification/complete-profile/process.php" method="post">
        ...
        <div class="modal-footer col d-flex justify-content-center form-group">
          <button type="submit" name="add_profile_btn" class="focus-ring btn btn-outline-secondary btn-sm">Submit</button>
        </div>
      </form>
