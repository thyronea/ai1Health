<!-- Modal -->
<div class="modal fade" id="rv_2nd-Modal" tabindex="-1" aria-labelledby="rv_2nd-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="rv_2nd-ModalLabel">2nd Rotavirus</h1>
      </div>
      <div class="modal-body">
        <div class="tab-content" id="pills-tabContent">
          ...
          <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
            ...
            $vaccine = "SELECT * FROM immunization WHERE groupID='$groupID' AND patientID='$patientID' AND type='2nd Rotavirus' ";
            $vaccine_run = mysqli_query($con, $vaccine);
            if(mysqli_num_rows($vaccine_run) > 0 )
            {
              foreach ($vaccine_run as $rv_2nd){}
            }
            ?>
      ...
      <div class="modal-footer col d-flex justify-content-center">
        ...
        <ul class="nav nav-pills" id="pills-tab" role="tablist">
          ...
          <!-- Edit Button -->
          <li class="nav-item" role="presentation">
            <button title="Edit" type="button" class="nav-link focus-ring py-1 px-2 btn text-decoration-none border-none" data-bs-toggle="modal" data-bs-target="#rv_2nd-edit-Modal" style="color:black">
