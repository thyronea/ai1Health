...
<!-- Modal -->
<div class="modal fade" id="DTaP-3rd-Modal" tabindex="-1" aria-labelledby="DTaP-3rd-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="DTaP-3rd-ModalLabel">3rd DTaP</h1>
        ...
        <form action="../process/sql.php" method="POST" align="left">
            <div class="row mt-3">
              <div class="col-md-6">
                ...
                <input type="hidden" class="form-control form-control-sm mt-2" name="type" value="3rd DTap" required>
          ...
          <div class="mt-4" align="center">
            <button type="submit" name="DTaP_3rd" class="focus-ring py-1 px-2 btn-outline border btn btn-sm">Submit</button>
          </div>
