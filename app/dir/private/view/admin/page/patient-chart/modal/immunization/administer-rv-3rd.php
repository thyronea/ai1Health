...
<!-- Modal -->
<div class="modal fade" id="rv-3rd-Modal" tabindex="-1" aria-labelledby="rv-3rd-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="rv-3rd-ModalLabel">3rd Rotavirus</h1>
        ...
        <form action="../process/sql.php" method="POST" align="left">
            <div class="row mt-3">
              <div class="col-md-6">
                ...
                <input type="hidden" class="form-control form-control-sm mt-2" name="type" value="3rd Rotavirus" required>
          ...
          <div class="mt-4" align="center">
            <button type="submit" name="rv_3rd" class="focus-ring py-1 px-2 btn-outline border btn btn-sm">Submit</button>
          </div>
