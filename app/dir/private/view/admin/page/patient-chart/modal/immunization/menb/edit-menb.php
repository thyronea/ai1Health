<?php $menb_vis = date('2021') . '-' . date('08') . '-' . date('06');  ?>

<div class="modal fade" id="edit_administered_menb" tabindex="-1" aria-labelledby="edit_administered_menbLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="edit_administered_menbLabel">Meningococcal B</h1>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <form class="" action="process/immunization/update-iz.php" method="post">
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="shotID" id="menb_edit_ID" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="uniqueID" id="menb_edit_uniqueID" required>
            ...
            <select id="edit_menb_vaccines" name="vaccineID" class="form-select form-select-sm mb-4" onchange="edit_menb()">
              <option>Select from inventory</option>
                  <?php
                    $groupID = mysqli_real_escape_string($con, $_SESSION['groupID']);
                    $sql = "SELECT * FROM inventory WHERE groupID='$groupID' AND name='MenB - Trumenba Single Dose Syringes' ";
                    $sql_run = mysqli_query($con, $sql);
                    $trumenba_SDS = mysqli_num_rows($sql_run);
                    while ($trumenba_SDS = mysqli_fetch_array($sql_run))
                    {
                      echo "<option value='". htmlspecialchars($trumenba_SDS['id']) ."'>" .htmlspecialchars($trumenba_SDS['name']) .' ' .'('.htmlspecialchars($trumenba_SDS['funding_source']).')' ."</option>" ;
                    }

                    $sql = "SELECT * FROM inventory WHERE groupID='$groupID' AND name='MenB - Bexsero Single Dose Syringes' ";
                    $sql_run = mysqli_query($con, $sql);
                    $bexero_SDS = mysqli_num_rows($sql_run);
                    while ($bexero_SDS = mysqli_fetch_array($sql_run))
                    {
                      echo "<option value='". htmlspecialchars($bexero_SDS['id']) ."'>" .htmlspecialchars($bexero_SDS['name']) .' ' .'('.htmlspecialchars($bexero_SDS['funding_source']).')' ."</option>" ;
                    }
                  ?>
            </select>
            ...
            <div class="row mb-2">
                <div class="col">
                  <input type="text" id="edit_menb_name" name="vaccine" class="form-control form-control-sm" value="" required>
                </div>
            </div>
            
             <div class="row mb-2">
                <div class="col">
                  <input type="text" id="edit_menb_lot" name="lot" class="form-control form-control-sm" value="" placeholder="Lot Number" required>
                </div>
                <div class="col">
                  <input type="text" id="edit_menb_ndc" name="ndc" class="form-control form-control-sm" value="" placeholder="NDC" required>
                </div>
             </div>
             <?php
             ...
             <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" id="edit_menb_exp" name="exp" class="form-control form-control-sm" value="" required>
                </div>
              </div>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <select class="form-select form-select-sm" name="site" id="menb_edit_site" required>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <select class="form-select form-select-sm" name="route" id="menb_edit_route" required>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" name="vis_given" id="menb_edit_vis_given" class="form-control form-control-sm" value="<?php echo $today; ?>" required>
                </div>
              </div>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" name="vis" id="menb_vis" class="form-control form-control-sm" value="<?php echo $menb_vis; ?>" required>
                </div>
              </div>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="edit_menb_funding" name="edit_menb_funding" class="form-control form-control-sm" onChange="edit_validate_menb()" hidden required>
                  <select id="edit_menb_eligibility" name="edit_menb_eligibility" class="form-select form-select-sm" onChange="edit_validate_menb()">
                    <option></option>
              ...
              <div class="row">
                <div class="col">
                  <textarea name="comment" class="form-control form-control-sm" id="menb_edit_comment" placeholder="Comment......"></textarea>
                </div>
              </div>

            <a type="button" class="focus-ring btn btn-sm border mt-3" id="submit_btn" data-bs-toggle="modal" data-bs-target="#delete_menb">Delete</a>  
            <button type="submit" name="update_menb" class="focus-ring btn btn-sm border mt-3" id="submit_btn" >Update</button>
          </form>
        </div>
      </div>
    </div>
