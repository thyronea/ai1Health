<?php $hib_vis = date('2023') . '-' . date('08') . '-' . date('6'); ?>

<div class="modal fade" id="edit_administered_hib" tabindex="-1" aria-labelledby="edit_administered_hepbLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="edit_administered_hepbLabel">Hib</h1>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <form class="" action="process/immunization/update-iz.php" method="post">
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="shotID" id="hib_edit_ID" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="uniqueID" id="hib_edit_uniqueID" required>
            ...
            <select id="edit_hib_vaccines" name="vaccineID" class="form-select form-select-sm mb-4" onchange="edit_hib()">
            ...
            <div class="row mb-2">
                <div class="col">
                  <input type="" id="edit_hib_name" name="vaccine" class="form-control form-control-sm" value="" required>
                </div>
            </div>
            
             <div class="row mb-2">
                <div class="col">
                  <input type="text" id="edit_hib_lot" name="lot" class="form-control form-control-sm" value="" placeholder="Lot Number" required>
                </div>
                <div class="col">
                  <input type="text" id="edit_hib_ndc" name="ndc" class="form-control form-control-sm" value="" placeholder="NDC" required>
                </div>
             </div>
             ...
             <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" id="edit_hib_exp" name="exp" class="form-control form-control-sm" value="" required>
                </div>
              </div>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <select class="form-select form-select-sm" name="site" id="hib_edit_site" required>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <select class="form-select form-select-sm" name="route" id="hib_edit_route" required>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" name="vis_given" id="hib_edit_vis_given" class="form-control form-control-sm" value="<?php echo $today; ?>" required>
                </div>
              </div>

              <div class="row mb-2">
                <div class="col" align="right">
                  <label><small><a href="https://www.cdc.gov/vaccines/hcp/vis/vis-statements/hib.pdf" target="_blank" class="text-decoration-none">VIS Publication Date:</a></small></label>
                </div>
                <div class="col">
                  <input type="date" name="vis" id="hib_edit_vis" class="form-control form-control-sm" value="<?php echo $hib_vis; ?>" required>
                </div>
              </div>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="edit_hib_funding" name="edit_hib_funding" class="form-control form-control-sm" onChange="edit_validate_hib()" hidden required>
                  <select id="edit_hib_eligibility" name="edit_hib_eligibility" class="form-select form-select-sm" onChange="edit_validate_hib()">
                    <option></option>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <select class="form-select form-select-sm mb-2" id="hibadministered_by" name="administered_by" required>
              ...
              <div class="row">
                <div class="col">
                  <textarea name="comment" class="form-control form-control-sm" id="hib_edit_comment" placeholder="Comment......"></textarea>
                </div>
              </div>

            <a type="button" class="focus-ring btn btn-sm border mt-3" id="submit_btn" data-bs-toggle="modal" data-bs-target="#delete_hib">Delete</a>  
            <button type="submit" name="update_hib" class="focus-ring btn btn-sm border mt-3" id="submit_btn" >Update</button>
          </form>
        </div>
      </div>
    </div>
