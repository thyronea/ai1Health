  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="edit_administered_rotaLabel">Rotavirus</h1>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <form class="" action="process/immunization/update-iz.php" method="post">
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="shotID" id="rota_edit_ID" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="uniqueID" id="rota_edit_uniqueID" required>
            ...
            <select id="edit_rota_vaccines" name="vaccineID" class="form-select form-select-sm mb-4" onchange="edit_rota()">
            ...
            <div class="row mb-2">
             ...
             <div class="row mb-2">
                <div class="col">
                  <input type="text" id="edit_rota_lot" name="lot" class="form-control form-control-sm" value="" placeholder="Lot Number" required>
                </div>
                <div class="col">
                  <input type="text" id="edit_rota_ndc" name="ndc" class="form-control form-control-sm" value="" placeholder="NDC" required>
                </div>
             </div>
             <?php
             ...
             <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" id="edit_rota_exp" name="exp" class="form-control form-control-sm" value="" required>
                </div>
              </div>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <select class="form-select form-select-sm" name="site" id="rota_edit_site" required>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <select class="form-select form-select-sm" name="route" id="rota_edit_route" required>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" name="vis_given" id="rota_edit_vis_given" class="form-control form-control-sm" value="<?php echo $today; ?>" required>
                </div>
              </div>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" name="vis" id="rota_vis" class="form-control form-control-sm" value="<?php echo $hepB_vis; ?>" required>
                </div>
              </div>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="edit_rota_funding" name="edit_rota_funding" class="form-control form-control-sm" onChange="edit_validate_rota()" hidden required>
                  <select id="edit_rota_eligibility" name="edit_rota_eligibility" class="form-select form-select-sm" onChange="edit_validate_rota()">
                    <option></option>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <select class="form-select form-select-sm mb-2" id="rotaadministered_by" name="administered_by" required>
              ...
              <div class="row">
                <div class="col">
                  <textarea name="comment" class="form-control form-control-sm" id="rota_edit_comment" placeholder="Comment......"></textarea>
                </div>
              </div>

            <a type="button" class="focus-ring btn btn-sm border mt-3" id="submit_btn" data-bs-toggle="modal" data-bs-target="#delete_rota">Delete</a>  
            <button type="submit" name="update_rota" class="focus-ring btn btn-sm border mt-3" id="submit_btn" >Update</button>
          </form>
        </div>
      </div>
    </div>
