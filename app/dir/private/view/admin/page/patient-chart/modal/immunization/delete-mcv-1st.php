<!-- Modal -->
<div class="modal fade" id="delete_mcv_1st" tabindex="-1" data-bs-backdrop="static" aria-labelledby="delete_mcv_1st-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">

      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="delete_mcv_1st-ModalLabel">Delete</h1>
      </div>
      ...
      <div class="modal-body">
        <form action="../process/sql.php" method="POST">
          <div class="form-group mt-3 mb-5">
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="vaccine_name" value="<?=htmlspecialchars(decryptthis($mcv_1st['vaccine'], $key));?>" required>
            ...
            <!----------------------------------------------------->
            <p align="center"><?=htmlspecialchars($mcv_1st['type']);?> will be permanently removed.</p>
