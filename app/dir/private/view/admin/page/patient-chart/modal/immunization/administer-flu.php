...
$vis = date('2021') . '-' . date('08') . '-' . date('06');
?>


<!-- Modal -->
<div class="modal fade" id="flu-Modal" tabindex="-1" aria-labelledby="flu-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="flu-ModalLabel">Influenza</h1>
      ...
      <div class="modal-body">
        <form action="../process/sql.php" method="POST" align="left">
            <div class="row mt-3">
              <div class="col-md-6">
                ...
                <select id="vaccines" name="vaccine" class="form-select form-select-sm" required>
                  ...
                  $sql = "SELECT * FROM vaccines WHERE groupID='$groupID' AND vaccine='Influenza - Fluarix Single Dose Syringes' ";
                  ...
                  $sql = "SELECT * FROM vaccines WHERE groupID='$groupID' AND vaccine='Influenza - Flucelvax Single Dose Syringes' ";
                  $sql_run = mysqli_query($con, $sql);
                  ...
                  $sql = "SELECT * FROM vaccines WHERE groupID='$groupID' AND vaccine='Influenza - FluLaval Single Dose Syringes' ";
                  $sql_run = mysqli_query($con, $sql);
                  ...
                  $sql = "SELECT * FROM vaccines WHERE groupID='$groupID' AND vaccine='Influenza - Fluzone Single Dose Syringes' ";
                  $sql_run = mysqli_query($con, $sql);
                  ...
                  $sql = "SELECT * FROM vaccines WHERE groupID='$groupID' AND vaccine='Influenza - Flumist Intranasal Sprayer' ";
                  $sql_run = mysqli_query($con, $sql);
          ...
          <div class="mt-4" align="center">
            <button type="submit" name="flu" class="focus-ring py-1 px-2 btn-outline border btn btn-sm">Submit</button>
          </div>
