<!-- Modal -->
<div class="modal fade" id="pcv_3rd-edit-Modal" tabindex="-1" aria-labelledby="pcv_3rd-edit-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="pcv_3rd-edit-ModalLabel">Edit - 3rd PCV</h1>
      </div>
      <div class="modal-body">
        <form action="../process/sql.php" method="POST">
          <div class="row">
            <input type="hidden" class="form-control form-control-sm mt-2" name="id" value="<?=htmlspecialchars($pcv_3rd['id']);?>" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="engineID" value="<?=htmlspecialchars($pcv_3rd['engineID']);?>" required>
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="type" value="<?=htmlspecialchars($pcv_3rd['type']);?>" required>
          </div>
          <div class="row mb-2">
            <div class="col-md-3">
              <label><small>Date</small></label>
              <input type="date" name="date" class="form-control form-control-sm" value="<?= htmlspecialchars($pcv_3rd['date']); ?>" required>
            </div>
            <div class="col-md-3">
              <label><small>Time</small></label>
              <input type="text" name="time" class="form-control form-control-sm" value="<?= htmlspecialchars($pcv_3rd['time']); ?>" required>
            </div>
            <div class="col-md-6">
              <label><small>Vaccine</small></label>
              <input type="text" name="vaccine" class="form-control form-control-sm" value="<?= htmlspecialchars(decryptthis($pcv_3rd['vaccine'], $key)); ?>" required>
            </div>
          </div>
          <div class="row mb-2">
            <div class="col-md-3">
              ...
              <select class="form-select form-select-sm" name="manufacturer" required>
                <option selected><?= htmlspecialchars(decryptthis($pcv_3rd['manufacturer'], $key)); ?></option>
            ...
            <div class="col-md-3">
              ...
              <input type="text" name="ndc" class="form-control form-control-sm" value="<?= htmlspecialchars(decryptthis($pcv_3rd['ndc'], $key)); ?>" required>
            </div>
            <div class="col-md-3">
              <label><small>Lot Number</small></label>
              <input type="text" name="lot" class="form-control form-control-sm" value="<?= htmlspecialchars(decryptthis($pcv_3rd['lot'], $key)); ?>" required>
            </div>
            <div class="col-md-3">
              <label><small>Expiration Date</small></label>
              <input type="date" name="exp" class="form-control form-control-sm" value="<?= htmlspecialchars(decryptthis($pcv_3rd['exp'], $key)); ?>" required>
            </div>
          </div>
          <div class="row mb-2">
            <div class="col-md-3">
              ...
              <select class="form-select form-select-sm" name="site" required>
                <option selected><?= htmlspecialchars(decryptthis($pcv_3rd['site'], $key)); ?></option>
            ...
            <div class="col-md-3">
              ...
              <select class="form-select form-select-sm" name="route" required>
                <option selected><?= htmlspecialchars(decryptthis($pcv_3rd['route'], $key)); ?></option>
            ...
            <div class="col-md-3">
              ...
              <input type="date" name="vis" class="form-control form-control-sm" value="<?= htmlspecialchars(decryptthis($pcv_3rd['vis'], $key)); ?>" required>
            </div>
            <div class="col-md-3">
              <label><small>VIS Given</small></label>
              <input type="date" name="vis_given" class="form-control form-control-sm" value="<?= htmlspecialchars(decryptthis($pcv_3rd['vis_given'], $key)); ?>" required>
            </div>
          </div>
          <div class="row mb-2">
            <div class="col-md-6">
              <label><small>Administered By</small></label>
              <input type="text" name="administered_by" class="form-control form-control-sm" value="<?= htmlspecialchars(decryptthis($pcv_3rd['administered_by'], $key)); ?>" required>
            </div>
            <div class="col-md-6">
              <label><small>Funding Source</small></label>
              <select class="form-select form-select-sm" name="funding_source" required>
                <option selected><?= htmlspecialchars(decryptthis($pcv_3rd['funding_source'], $key)); ?></option>
          ...
          <div class="row mt-3">
            <div class="col">
              ...
              <textarea name="comment" class="form-control form-control-sm"><?= htmlspecialchars(decryptthis($pcv_3rd['comment'], $key)); ?></textarea>
            </div>
          </div>
      </div>
      ...
      <div class="modal-footer nav col d-flex justify-content-center mt-3">
        ...
        <ul class="nav nav-pills" id="pills-tab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button title="Back" type="button" class="nav-link focus-ring py-1 px-2 text-decoration-none border-none mb-2" data-bs-toggle="modal" data-bs-target="#pcv_3rd-Modal" style="color:black">
          ...
          <!-- Delete Button -->
          <li class="nav-item" role="presentation">
            <button title="Delete" type="button" class="nav-link focus-ring py-1 px-2 text-decoration-none border-none" data-bs-toggle="modal" data-bs-target="#delete_pcv_3rd" style="color:red">
