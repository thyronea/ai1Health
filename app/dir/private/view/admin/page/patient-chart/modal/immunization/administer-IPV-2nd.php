...
<!-- Modal -->
<div class="modal fade" id="IPV-2nd-Modal" tabindex="-1" aria-labelledby="IPV-2nd-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="IPV-2nd-ModalLabel">2nd IPV</h1>
        ...
        <form action="../process/sql.php" method="POST" align="left">
            <div class="row mt-3">
              <div class="col-md-6">
                ...
                <input type="hidden" class="form-control form-control-sm mt-2" name="type" value="2nd IPV" required>
                <select id="vaccines" name="vaccine" class="form-select form-select-sm" required>
                  ...
                  $sql = "SELECT * FROM vaccines WHERE groupID='$groupID' AND vaccine='IPV - IPOL 10 Dose Vials' ";
            ...
            <div class="row mt-3">
              <div class="col">
                ...
                <select class="form-select form-select-sm" name="site" required>
                  ...
                  <option selected value="L-Thigh">L-Thigh</option>
          ...
          <div class="mt-4" align="center">
            <button type="submit" name="IPV_2nd" class="focus-ring py-1 px-2 btn-outline border btn btn-sm">Submit</button>
          </div>
