...
<!-- Modal -->
<div class="modal fade" id="varicella-1st-Modal" tabindex="-1" aria-labelledby="varicella-1st-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="varicella-1st-ModalLabel">1st Varicella</h1>
        ...
        <form action="../process/sql.php" method="POST" align="left">
            <div class="row mt-3">
              <div class="col-md-6">
                ...
                <input type="hidden" class="form-control form-control-sm mt-2" name="type" value="1st Varicella" required>
          ...
          <div class="mt-4" align="center">
            <button type="submit" name="varicella_1st" class="focus-ring py-1 px-2 btn-outline border btn btn-sm">Submit</button>
          </div>
