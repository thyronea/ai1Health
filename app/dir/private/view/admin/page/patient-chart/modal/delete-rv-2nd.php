<!-- Modal -->
<div class="modal fade" id="delete_rv_2nd" tabindex="-1" data-bs-backdrop="static" aria-labelledby="delete_rv_3rd-ModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <form action="../process/sql.php" method="POST">
          <div class="form-group mt-3 mb-5">
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="id" value="<?=htmlspecialchars($rv_2nd['id']);?>" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="vaccine_name" value="<?=htmlspecialchars(decryptthis($rv_2nd['vaccine'], $key));?>" required>
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="type" value="<?=htmlspecialchars($rv_2nd['type']);?>" required>
            <!----------------------------------------------------->
            <p align="center"><?=htmlspecialchars($rv_2nd['type']);?> will be permanently removed.</p>
