      ...
      <div class="modal-body">
        <div class="col-md-12">
          <form class="" action="process/immunization/update-iz.php" method="post">
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="hepB_ID" id="hepB_ID" required>
            ...
            <select id="hepB_name" name="vaccine" class="form-select form-select-sm mb-2" required>
             ...
             <div class="row mb-2">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <select class="form-select form-select-sm" name="site" id="hepB_site" required>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" name="vis_given" id="hepB_vis_given" class="form-control form-control-sm" value="<?php echo $today; ?>" required>
                </div>
              </div>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <select class="form-select form-select-sm" id="hepB_funding_source" name="funding_source">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input type="text" name="administered_by" class="form-control form-control-sm" id="hepB_administered_by" placeholder="Administered By" required>
                </div>
              </div>

              <div class="row">
                <div class="col">
                  <textarea name="comment" class="form-control form-control-sm" id="hepB_comment" placeholder="Comment......"></textarea>
                </div>
              </div>
