      ...
      <div class="modal-body">
        <div class="col-md-8">
          <form class="" action="../process/sql.php" method="post">
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="groupID" id="emergency_groupID" required>
            ...
            <button type="submit" name="patient_emergencybtn" class="focus-ring btn btn-sm border mt-3">Save</button>
          </form>
        </div>
      </div>
    </div>
