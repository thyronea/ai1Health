...
<!-- Modal -->
<div class="modal fade" id="rv-2nd-Modal" tabindex="-1" aria-labelledby="rv-2nd-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="rv-2nd-ModalLabel">2nd Rotavirus</h1>
        ...
        <form action="../process/sql.php" method="POST" align="left">
            <div class="row mt-3">
              <div class="col-md-6">
                ...
                <input type="hidden" class="form-control form-control-sm mt-2" name="type" value="2nd Rotavirus" required>
          ...
          <div class="mt-4" align="center">
            <button type="submit" name="rv_2nd" class="focus-ring py-1 px-2 btn-outline border btn btn-sm">Submit</button>
          </div>
