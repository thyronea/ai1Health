<div class="tab-pane fade" id="mmr" role="tabpanel" tabindex="0">
    <div class="d-flex align-items-start row">
                    ...
                    <?php
                        ...
                        if($searchnum > 0)
                        {
                            ...
                            {   
                                ...
                                $admin_mmr = (date('m', strtotime($admin_date)) . '/' . date('d', strtotime($admin_date)) . '/' . date('Y', strtotime($admin_date))); 
        ...
        <div class="row col-md-10 mt-2 mb-3">
            <div class="">
                <p>MMR <a href="https://www.cdc.gov/vaccines/hcp/vis/vis-statements/mmr.pdf" target="_blank" class="text-decoration-none text-secondary"><small>(Measles/Mumps/Rubella)</small></a> - 2 Dose Series</p>
