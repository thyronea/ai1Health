...
<div class="tab-pane fade show active" id="history" role="tabpanel" tabindex="0">
    <div class="row col-md-12">
        ...
        -->
        <div class="d-flex col flex-column mt-2 mb-3" align="left">
            <small>
                <div> <!-- Schedule -->
                    <button type="button" id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><b>1st</b></small></button>
                    <button type="button" id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><b>2nd</b></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><b>3rd</b></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><b>4th</b></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><b>5th</b></small></button>
                </div>
                <div> <!-- Blank -->
                    <button id="btn" class="py-1 px-2 btn btn-sm border-0 rounded-3"></button>
                </div>
                <div> <!-- RSV -->
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$dob;?></small></button>
                </div>
                <div> <!--  Hep B-->
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$dob;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month2old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month6old;?></small></button>
                </div>
                <div > <!-- RV -->
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month2old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month4old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month6old;?></small></button>
                </div>
                <div> <!-- DTaP -->
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month2old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month4old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month6old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month15old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month18old;?></small></button>
                </div>
                <div> <!-- Hib -->
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month2old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month4old;?></small></button>
                ...
                <div> <!-- PCV -->
                    ...
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month4old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month6old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$year1old;?></small></button>
                </div>
                <div > <!-- IPV -->
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month2old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month4old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$month6old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$year4old;?></small></button>
                </div>
                <div> <!-- MMR -->
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$year1old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$year4old;?></small></button>
                ...
                <div> <!-- Tdap -->
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$year11old;?></small></button>
                </div>
                <div> <!-- HPV -->
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$year11old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$year11_6month_old;?></small></button>
                </div>
                <div> <!-- MCV -->
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$year11old;?></small></button>
                ...
                <div> <!-- Men B Bexsero-->
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$year16old;?></small></button>
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$year16_1month_old;?></small></button>
                </div>
                <!-- Trumenba
                <div style="margin-top: 6px">
                    <button id="btn" class="focus-ring py-1 px-2 btn btn-sm border rounded-3"><small><?=$year16old;?></small></button>
