                            ...
                            {   
                                ...
                                ?>
                                    <tr align="center">
                                        ...
                                        <td >
                                            <a class="text-decoration-none focus-ring edit_rsv_btn" style="color: black; font-size: 14px" data-bs-toggle="modal" data-bs-target="#edit_administered_rsv">
                                                <div class="card shadow" id="admin_card">
                                                    <div class="card-body">
                                                        <small><?=htmlspecialchars($admin_rsv);?></small>
                                                    </div>
                                                </div>
                                            </a>
                                        </td>
