<div class="tab-pane fade" id="covid" role="tabpanel" tabindex="0">
    <div class="d-flex align-items-start row">
                    ...
                    <?php
                        ...
                        if($searchnum > 0)
                        {
                            ...
                            {   
                                ...
                                $admin_covid = (date('m', strtotime($admin_date)) . '/' . date('d', strtotime($admin_date)) . '/' . date('Y', strtotime($admin_date))); 
                                ...
                                <tr align="center">
                                    ...
                                    <td >
                                        <a class="text-decoration-none focus-ring edit_covid_btn" style="color: black; font-size: 14px" data-bs-toggle="modal" data-bs-target="#edit_administered_covid">
                                            <div class="card shadow" id="admin_card">
                                                <div class="card-body">
                                                    <small><?=htmlspecialchars($admin_covid);?></small>
                                                </div>
                                            </div>
                                        </a>
                                    </td>
        ...
        <div class="row col-md-10 mt-2 mb-3">
            <div class="">
                <p>COVID-19 <a href="https://www.cdc.gov/vaccines/hcp/vis/vis-statements/covid-19.pdf" target="_blank" class="text-decoration-none text-secondary"><small>(1vCOV-mRNA, 1vCOV-aPS)</small></a></p>
                <div class="progress" role="progressbar" aria-valuemin="0" aria-valuemax="100" style="height: 25px">
                    <div class="progress-bar progress-bar-striped progress-bar-animated" style="width: <?=$covid_count;?>%"><?=$covid_count;?>%</div>
                </div>
                <div class="mt-3">
                    <?=$covid_message?> 
                </div>
