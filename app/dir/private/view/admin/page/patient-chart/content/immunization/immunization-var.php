<div class="tab-pane fade" id="var" role="tabpanel" tabindex="0">
    <div class="d-flex align-items-start row">
            ...
            <table class="table table-borderless text-nowrap">
                <tbody align="center" style="text-align: left">
                    <?php
                        ...
                        $vaccine = htmlspecialchars("Varicella");
                        ...
                        if($searchnum > 0)
                        {
                            ...
                            {   
                                ...
                                $admin_var = (date('m', strtotime($admin_date)) . '/' . date('d', strtotime($admin_date)) . '/' . date('Y', strtotime($admin_date))); 
                                ...
                                <tr align="center">
                                    ...
                                    <td >
                                        <a class="text-decoration-none focus-ring edit_var_btn" style="color: black; font-size: 14px" data-bs-toggle="modal" data-bs-target="#edit_administered_var">
                                            <div class="card shadow" id="admin_card">
                                                <div class="card-body">
                                                    <small><?=htmlspecialchars($admin_var);?></small>
                                                </div>
                                            </div>
                                        </a>
                                    </td>
        ...
        <div class="row col-md-10 mt-2 mb-3">
            <div class="">
                <p>Varicella <a href="https://www.cdc.gov/vaccines/hcp/vis/vis-statements/varicella.pdf" target="_blank" class="text-decoration-none text-secondary"><small>(Chickenpox)</small></a> - 2 Dose Series</p>
