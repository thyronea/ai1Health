<div class="tab-pane fade" id="hpv" role="tabpanel" tabindex="0">
    <div class="d-flex align-items-start row">
        ...
        <div class="row col-md-10 mt-2 mb-3">
            <div class="">
                <p>HPV <a href="https://www.cdc.gov/vaccines/hcp/vis/vis-statements/ipv.pdf" target="_blank" class="text-decoration-none text-secondary"><small>(Polio)</small></a> - 3 Dose Series</p>
