<div class="tab-pane fade" id="dtap" role="tabpanel" tabindex="0">
    <div class="d-flex align-items-start row">
                    ...
                    <?php
                        ...
                        if($searchnum > 0)
                        {
                            ...
                            {   
                                ...
                                $admin_dtap = (date('m', strtotime($admin_date)) . '/' . date('d', strtotime($admin_date)) . '/' . date('Y', strtotime($admin_date))); 
                                ...
                                <tr align="center">
                                    ...
                                    <td >
                                        <a class="text-decoration-none focus-ring edit_dtap_btn" style="color: black; font-size: 14px" data-bs-toggle="modal" data-bs-target="#edit_administered_dtap">
                                            <div class="card shadow" id="admin_card">
                                                <div class="card-body">
                                                    <small><?=htmlspecialchars($admin_dtap);?></small>
                                                </div>
                                            </div>
                                        </a>
                                    </td>
        ...
        <div class="row col-md-10 mt-2 mb-3">
            <div class="">
                <p>DTaP <a href="https://www.cdc.gov/vaccines/hcp/vis/vis-statements/dtap.pdf" target="_blank" class="text-decoration-none text-secondary"><small>(Diphtheria, Tetanus, Pertussis)</small></a> - 5 Dose Series</p>
