                 ...
                 if($searchnum > 0)
                 {
                   foreach ($query_run as $patient)
                   {
                     ...
                     <tr>
                       ...
                       <td hidden><a type="button" href="../patient-chart/index.php?patientID=<?=htmlspecialchars($patient['patientID']);?>" class="focus-ring text-decoration-none" style="color: black"><i class="bi bi-universal-access-circle"></i></a></td>
