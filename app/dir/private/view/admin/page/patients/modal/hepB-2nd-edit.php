<!-- Modal -->
<div class="modal fade" id="hepB_2nd-edit-Modal" tabindex="-1" aria-labelledby="hepB_2nd-edit-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="hepB_2nd-edit-ModalLabel">Edit - 2nd Hep B</h1>
      </div>
      <div class="modal-body">
        <form action="../process/sql.php" method="POST">
          <div class="row">
            <input type="hidden" class="form-control form-control-sm mt-2" name="id" value="<?=htmlspecialchars($hepB_2nd['id']);?>" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="engineID" value="<?=htmlspecialchars($hepB_2nd['engineID']);?>" required>
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="type" value="<?=htmlspecialchars($hepB_2nd['type']);?>" required>
          </div>
          <div class="row mb-2">
            <div class="col-md-3">
              <label><small>Date</small></label>
              <input type="date" name="date" class="form-control form-control-sm" value="<?= htmlspecialchars($hepB_2nd['date']); ?>" required>
            </div>
            <div class="col-md-3">
              <label><small>Time</small></label>
              <input type="text" name="time" class="form-control form-control-sm" value="<?= htmlspecialchars($hepB_2nd['time']); ?>" required>
            </div>
            <div class="col-md-6">
              <label><small>Vaccine</small></label>
              <input type="text" name="vaccine" class="form-control form-control-sm" value="<?= htmlspecialchars(decryptthis($hepB_2nd['vaccine'], $key)); ?>" required>
            </div>
          </div>
          <div class="row mb-2">
            <div class="col-md-3">
              ...
              <select class="form-select form-select-sm" name="manufacturer" required>
                <option selected><?= htmlspecialchars(decryptthis($hepB_2nd['manufacturer'], $key)); ?></option>
            ...
            <div class="col-md-3">
              ...
              <input type="text" name="ndc" class="form-control form-control-sm" value="<?= htmlspecialchars(decryptthis($hepB_2nd['ndc'], $key)); ?>" required>
            </div>
            <div class="col-md-3">
              <label><small>Lot Number</small></label>
              <input type="text" name="lot" class="form-control form-control-sm" value="<?= htmlspecialchars(decryptthis($hepB_2nd['lot'], $key)); ?>" required>
            </div>
            <div class="col-md-3">
              <label><small>Expiration Date</small></label>
              <input type="date" name="exp" class="form-control form-control-sm" value="<?= htmlspecialchars(decryptthis($hepB_2nd['exp'], $key)); ?>" required>
            </div>
          </div>
          <div class="row mb-2">
            <div class="col-md-3">
              ...
              <select class="form-select form-select-sm" name="site" required>
                <option selected><?= htmlspecialchars(decryptthis($hepB_2nd['site'], $key)); ?></option>
            ...
            <div class="col-md-3">
              ...
              <select class="form-select form-select-sm" name="route" required>
                <option selected><?= htmlspecialchars(decryptthis($hepB_2nd['route'], $key)); ?></option>
            ...
            <div class="col-md-3">
              ...
              <input type="date" name="vis" class="form-control form-control-sm" value="<?= htmlspecialchars(decryptthis($hepB_2nd['vis'], $key)); ?>" required>
            </div>
            <div class="col-md-3">
              <label><small>VIS Given</small></label>
              <input type="date" name="vis_given" class="form-control form-control-sm" value="<?= htmlspecialchars(decryptthis($hepB_2nd['vis_given'], $key)); ?>" required>
            </div>
          </div>
          <div class="row mb-2">
            <div class="col-md-6">
              <label><small>Administered By</small></label>
              <input type="text" name="administered_by" class="form-control form-control-sm" value="<?= htmlspecialchars(decryptthis($hepB_2nd['administered_by'], $key)); ?>" required>
            </div>
            <div class="col-md-6">
              <label><small>Funding Source</small></label>
              <select class="form-select form-select-sm" name="funding_source" required>
                <option selected><?= htmlspecialchars(decryptthis($hepB_2nd['funding_source'], $key)); ?></option>
          ...
          <div class="row mt-3">
            <div class="col">
              ...
              <textarea name="comment" class="form-control form-control-sm"><?= htmlspecialchars(decryptthis($hepB_2nd['comment'], $key)); ?></textarea>
            </div>
          </div>
      </div>
      ...
      <div class="modal-footer nav col d-flex justify-content-center mt-3">
        ...
        <ul class="nav nav-pills" id="pills-tab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button title="Back" type="button" class="nav-link focus-ring py-1 px-2 text-decoration-none border-none mb-2" data-bs-toggle="modal" data-bs-target="#hepB_2nd-Modal" style="color:black">
          ...
          <!-- Delete Button -->
          <li class="nav-item" role="presentation">
            <button title="Delete" type="button" class="nav-link focus-ring py-1 px-2 text-decoration-none border-none" data-bs-toggle="modal" data-bs-target="#delete_hepB_2nd" style="color:red">
