<!-- Modal -->
<div class="modal fade" id="covid-vaccine-Modal" tabindex="-1" aria-labelledby="covid-vaccine-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <form action="../process/sql.php" method="post">
      <div class="modal-content">
        <div class="modal-header text-center">
          <h1 class="modal-title w-100 fs-5" id="covid-vaccine-ModalLabel">COVID-19</h1>
        </div>
            ...
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
              <table class="focus-ring table table-sm text-nowrap table-borderless">
                <div class="row">
                  ...
                  <input type="hidden" class="form-control form-control-sm mt-2" name="engineID" id="covid_engineID" class="form-control form-control-sm" required>
                  <input type="hidden" class="form-control form-control-sm mt-2" name="patientID" id="covid_patientID" class="form-control form-control-sm" required>
                  <input type="hidden" class="form-control form-control-sm mt-2" name="id" id="covid_id" class="form-control form-control-sm" required>
                  <input type="hidden" class="form-control form-control-sm mt-2" name="type" id="type" class="form-control form-control-sm" required>
                </div>
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    <td><small><input type="date" name="date" id="date" class="form-control form-control-sm" required></small></td>
                    <td><small><input type="text" name="time" id="time" class="form-control form-control-sm" required></small></td>
                    <td colspan="2"><small><input type="text" name="vaccine" id="vaccine" class="form-control form-control-sm" required></small></td>
                  </tr>
                </tbody>
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    <td>
                      <small><select class="form-select form-select-sm" name="manufacturer" id="manufacturer" required>
                    ...
                    <td><small><input type="text" name="ndc" id="covid_ndc" class="form-control form-control-sm" required></small></td>
                    <td><small><input type="text" name="lot" id="covid_lot" class="form-control form-control-sm" required></small></td>
                    <td><small><input type="date" name="exp" id="covid_exp" class="form-control form-control-sm" required></small></td>
                  </tr>
                </tbody>
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    <td>
                      <small><select class="form-select form-select-sm" name="site" id="site" required>
                    ...
                    <td>
                      <small><select class="form-select form-select-sm" name="route"  id="route" required>
                    ...
                    <td><small><input type="date" name="vis" id="vis" class="form-control form-control-sm" required></small></td>
                    <td><small><input type="date" name="vis_given" id="vis_given" class="form-control form-control-sm" required></small></td>
                  </tr>
                </tbody>
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    <td><small><input type="text" name="administered_by" id="administered_by" class="form-control form-control-sm" required></small></td>
                    <td>
                      <small><select class="form-select form-select-sm" name="funding_source" id="funding_source" required>
                      <option disabled selected>Select one</option>
                    ...
                    <td colspan="2"><small><input type="text" name="comment" id="comment" class="form-control form-control-sm"></small></td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div class="modal-footer col d-flex justify-content-center">
          ...
          <ul class="nav nav-pills" id="pills-tab" role="tablist">
            ...
            <!-- Delete Button -->
            <li class="nav-item" role="presentation">
              <button title="Delete" type="button" class="nav-link focus-ring py-1 px-2 text-decoration-none border-none" data-bs-toggle="modal" data-bs-target="#covid-history-Modal" style="color:red">
