...
<!-- Modal -->
<div class="modal fade" id="hpv-Modal" tabindex="-1" aria-labelledby="hpv-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="hpv-ModalLabel">HPV</h1>
      ...
      <div class="modal-body">
        <form action="../process/sql.php" method="POST" align="left">
            <div class="row mt-3">
              ...
              <div class="col-md-3">
                <label><small>Scheduled Dose:</small></label>
                <select class="form-select form-select-sm" name="type" required>
                  <option disabled selected>Select one</option>
                  <option value="1st HPV">1st</option>
                  <option value="2nd HPV">2nd</option>
                  <option value="3rd HPV">3rd</option>
                </select>
              </div>
              <div class="col">
          ...
          <div class="mt-4" align="center">
            <button type="submit" name="hpv" class="focus-ring py-1 px-2 btn-outline border btn btn-sm">Submit</button>
          </div>
