<!-- Modal -->
<div class="modal fade" id="delete_hepB_1st" tabindex="-1" data-bs-backdrop="static" aria-labelledby="delete_hepB_1st-ModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <form action="../process/sql.php" method="POST">
          <div class="form-group mt-3 mb-5">
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="vaccine_name" value="<?=htmlspecialchars(decryptthis($hepB_1st['vaccine'], $key));?>" required>
            ...
            <!----------------------------------------------------->
            <p align="center"><?=htmlspecialchars($hepB_1st['type']);?> will be permanently removed.</p>
