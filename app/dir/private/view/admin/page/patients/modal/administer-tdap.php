...
<!-- Modal -->
<div class="modal fade" id="tdap-Modal" tabindex="-1" aria-labelledby="tdap-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="tdap-ModalLabel">Tdap</h1>
      ...
      <div class="modal-body">
        <form action="../process/sql.php" method="POST" align="left">
          ...
          <div class="mt-4" align="center">
            <button type="submit" name="tdap" class="focus-ring py-1 px-2 btn-outline border btn btn-sm">Submit</button>
          </div>
