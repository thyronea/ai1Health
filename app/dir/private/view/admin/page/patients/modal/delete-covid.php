<!-- Modal -->
<div class="modal fade" id="delete_covid" tabindex="-1" data-bs-backdrop="static" aria-labelledby="delete_covid-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">

      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="delete_covid-ModalLabel">Delete COVID-19</h1>
      </div>
      ...
      <div class="modal-body">
        <form action="../process/sql.php" method="POST">
          <div class="form-group mt-3 mb-5">
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="id" id="delete_covid_id" class="form-control form-control-sm" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="vaccine_name" id="delete_covid_name" class="form-control form-control-sm" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="type" id="delete_covid_type" class="form-control form-control-sm" required>
            <!----------------------------------------------------->
