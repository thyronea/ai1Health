...
<!-- Modal -->
<div class="modal fade" id="covid-Modal" tabindex="-1" aria-labelledby="covid-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="covid-ModalLabel">COVID-19</h1>
      ...
      <div class="modal-body">
        <form action="../process/sql.php" method="POST" align="left">
            <div class="row mt-3">
              <div class="col-md-6">
                ...
                <select id="vaccines" name="vaccine" class="form-select form-select-sm" required>
                  ...
                  $vaccine = htmlspecialchars('COVID-19 - Pfizer-BioNTech');
                  $sql = "SELECT * FROM vaccines WHERE groupID='$groupID' AND vaccine='$vaccine' ";
                  ...
                  $vaccine = htmlspecialchars('COVID-19 - Moderna');
                  $sql = "SELECT * FROM vaccines WHERE groupID='$groupID' AND vaccine='$vaccine' ";
                  $sql_run = mysqli_query($con, $sql);
                  ...
                  $vaccine = htmlspecialchars('COVID-19 - Novavax');
                  $sql = "SELECT * FROM vaccines WHERE groupID='$groupID' AND vaccine='$vaccine' ";
                  $sql_run = mysqli_query($con, $sql);
            ...
            <div class="row mt-3">
              ...
              <div class="col">
                <label><small><a href="https://www.cdc.gov/vaccines/covid-19/eua/index.html" target="_blank" class="text-decoration-none">EUA Fact Sheets:</a></small></label>
          ...
          <div class="mt-4" align="center">
            <button type="submit" name="covid" class="focus-ring py-1 px-2 btn-outline border btn btn-sm">Submit</button>
          </div>
