<div class="col-auto px-0">
   ...
   <div id="sidebar" class="collapse collapse-horizontal show border-none">
      <div class="list-group flex-column" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        <!-- Temp Log Summary Trigger -->
        <button title="View Summary Report" style="color:black; text-align: left" class="active focus-ring py-1 px-2 btn btn-sm border rounded-0 mt-3" id="v-pills-view-temp-summary-tab" data-bs-toggle="pill" data-bs-target="#v-pills-view-temp-summary" type="button" role="tab" aria-controls="v-pills-view-temp-summary" aria-selected="false">
          Summary
        </button>
        <!-- Temp Log Trigger -->
