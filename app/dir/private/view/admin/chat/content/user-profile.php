<div id="user_info" style="padding: 10px;">
        ...
        if(mysqli_num_rows($result) > 0 ) {
            ...
            ?>
                <a href="../../../img/profile/<?=$profile_img['filename'];?>" target="_blank">
                    <img id="profile_image" src="../../../img/profile/<?php echo $profile_img['filename'];?>">
                </a>
            <?php
            }
        }
    ...
    <span id="username">
        <a href="../../admin/profile/?userID=<?=$_SESSION['userID'];?>" target="_blank" style="color:white; text-decoration: none">
            <?=$_SESSION['fname'];?>
        </a>
    </span><br>
