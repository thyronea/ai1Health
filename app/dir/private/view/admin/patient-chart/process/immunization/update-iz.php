...
$vaccineID = htmlspecialchars($_POST['id']);
...
if(isset($_POST['update_hib']))
{
  $funding_source = mysqli_real_escape_string($con, $_POST['edit_hib_funding']);
  $eligibility = mysqli_real_escape_string($con, $_POST['edit_hib_eligibility']);
...
if(isset($_POST['update_pcv']))
{
  $funding_source = mysqli_real_escape_string($con, $_POST['edit_pcv_funding']);
  $eligibility = mysqli_real_escape_string($con, $_POST['edit_pcv_eligibility']);
...
if(isset($_POST['update_ipv']))
{
  $funding_source = mysqli_real_escape_string($con, $_POST['edit_ipv_funding']);
  $eligibility = mysqli_real_escape_string($con, $_POST['edit_ipv_eligibility']);
...
if(isset($_POST['update_covid']))
{
  $funding_source = mysqli_real_escape_string($con, $_POST['edit_covid_funding']);
  $eligibility = mysqli_real_escape_string($con, $_POST['edit_covid_eligibility']);
...
if(isset($_POST['update_flu']))
{
  $funding_source = mysqli_real_escape_string($con, $_POST['edit_flu_funding']);
  $eligibility = mysqli_real_escape_string($con, $_POST['edit_flu_eligibility']);
...
if(isset($_POST['update_mmr']))
{
  $funding_source = mysqli_real_escape_string($con, $_POST['edit_mmr_funding']);
  $eligibility = mysqli_real_escape_string($con, $_POST['edit_mmr_eligibility']);
...
{
  $funding_source = mysqli_real_escape_string($con, $_POST['edit_var_funding']);
  $eligibility = mysqli_real_escape_string($con, $_POST['edit_var_eligibility']);
...
if(isset($_POST['update_hepa']))
{
  $funding_source = mysqli_real_escape_string($con, $_POST['edit_hepa_funding']);
  $eligibility = mysqli_real_escape_string($con, $_POST['edit_hepa_eligibility']);
...
if(isset($_POST['update_tdap']))
{
  $funding_source = mysqli_real_escape_string($con, $_POST['edit_tdap_funding']);
  $eligibility = mysqli_real_escape_string($con, $_POST['edit_tdap_eligibility']);
