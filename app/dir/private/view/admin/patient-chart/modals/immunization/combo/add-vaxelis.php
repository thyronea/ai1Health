...
<div class="modal fade" id="administer_vaxelis" tabindex="-1" aria-labelledby="administer_vaxelisLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="administer_vaxelisLabel">Administer Vaxelis</h1>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <form class="" action="" method="post">
            ...
            <select id="vaxelis_ID" name="id" class="form-select form-select-sm mb-2" onchange="add_vaxelis()" required>
                  <option></option>
                  <option disabled>Select from inventory</option>
                  <?php
                    $groupID = mysqli_real_escape_string($con, $_SESSION['groupID']); $sql = "SELECT * FROM inventory WHERE groupID='$groupID' AND name='DTaP/IPV/Hib/Hep-B - Vaxelis Single Dose Vials' ";
                    ...
                    $groupID = mysqli_real_escape_string($con, $_SESSION['groupID']); $sql = "SELECT * FROM inventory WHERE groupID='$groupID' AND name='DTaP/IPV/Hib/Hep-B - Vaxelis Single Dose Syringes' ";
                    $sql_run = mysqli_query($con, $sql);
            ...
            <div class="row mb-2">
                <div class="col">
                  <input type="" id="add_vaxelis_vaccines" name="vaccine" class="form-control form-control-sm" value="" hidden required>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col">
                  <input type="" id="add_vaxelis_manu" name="manufacturer" class="form-control form-control-sm" value="" placeholder="Manufacturer" required>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col">
                  <input type="text" id="add_vaxelis_lot" name="lot" class="form-control form-control-sm" value="" placeholder="Lot Number" required>
                </div>
                <div class="col">
                  <input type="text" id="add_vaxelis_ndc" name="ndc" class="form-control form-control-sm" value="" placeholder="NDC" required>
                </div>
            </div>
            <?php
            ...
            <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" id="add_vaxelis_exp" name="exp" class="form-control form-control-sm" value="" required>
                </div>
            </div>
            ...
            <button type="submit" name="administer_vaxelis" class="focus-ring btn btn-sm border mt-3">Submit</button>
          </form>
        </div>
      </div>
    </div>
...
<script>
 function randomNumber(len) {
  ...
  document.getElementById("vaxelis_uniqueID").value = randomNumber(8);
</script>
