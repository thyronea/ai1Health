        ...
        <div class="col-md-12">
          <form class="" action="" method="post">
            ...
            <label><small>Vaccine</small></label>
             ...
             <div class="row mb-2">
                <div class="col">
                  <input type="" id="add_tdap_manu" name="manufacturer" class="form-control form-control-sm" value="" placeholder="Manufacturer" required>
                </div>
            </div>
             <div class="row mb-2">
                <div class="col">
             ...
             <div class="row mb-2">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="add_tdap_funding" name="funding" class="form-control form-control-sm" onChange="add_validate_tdap()" hidden required>
                  <select id="add_tdap_eligibility" name="eligibility" class="form-select form-select-sm" onChange="add_validate_tdap()" required>
                    <option></option>
            ...
            <button type="submit" name="administer_1ds" class="focus-ring btn btn-sm border mt-3">Submit</button>
          </form>
        </div>
      </div>
    </div>
