          ...
          <form class="" action="" method="post">
            ...
            <div class="row mb-2">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="add_ipv_funding" name="funding" class="form-control form-control-sm" onChange="add_validate_ipv()" hidden required>
                  <select id="add_ipv_eligibility" name="eligibility" class="form-select form-select-sm" onChange="add_validate_ipv()" required>
                    <option></option>
