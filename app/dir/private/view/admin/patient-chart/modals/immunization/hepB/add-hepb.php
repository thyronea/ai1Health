          ...
          <form class="" action="" method="post">
            ...
            <div class="row mb-2">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="add_hepB_funding" name="funding" class="form-control form-control-sm" onChange="add_validate_hepB()" hidden required>
                  <select id="add_hepB_eligibility" name="eligibility" class="form-select form-select-sm" onChange="add_validate_hepB()" required>
                    <option></option>
            ...
            <button type="submit" name="administer_3ds" class="focus-ring btn btn-sm border mt-3">Submit</button>
          </form>
        </div>
      </div>
    </div>
