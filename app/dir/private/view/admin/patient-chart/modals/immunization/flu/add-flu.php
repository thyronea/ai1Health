          ...
          <form class="" action="" method="post">
            ...
            <div class="row mb-2">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="add_flu_funding" name="funding" class="form-control form-control-sm" onChange="add_validate_flu()" hidden required>
                  <select id="add_flu_eligibility" name="eligibility" class="form-select form-select-sm" onChange="add_validate_flu()" required>
                    <option></option>
            ...
            <button type="submit" name="administer_" class="focus-ring btn btn-sm border mt-3">Submit</button>
          </form>
        </div>
      </div>
    </div>
