...
<div class="modal fade" id="administer_quadracel" tabindex="-1" aria-labelledby="administer_quadracelLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="administer_quadracelLabel">Administer Quadracel</h1>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <form class="" action="" method="post">
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="uniqueID" id="quadracel_uniqueID" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="type" value="QUADRACEL" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="combo_type" value="QUADRACEL" required>
            ...
            <select id="quadracel_ID" name="id" class="form-select form-select-sm mb-2" onchange="add_quadracel()" required>
                  <option></option>
                  <option disabled>Select from inventory</option>
                  <?php
                    $groupID = mysqli_real_escape_string($con, $_SESSION['groupID']); $sql = "SELECT * FROM inventory WHERE groupID='$groupID' AND name='DTaP/IPV - Quadracel Single Dose Vials' ";
                    $sql_run = mysqli_query($con, $sql);
                    $quadracel_SDV = mysqli_num_rows($sql_run);
                    while ($quadracel_SDV = mysqli_fetch_array($sql_run))
                    {
                      echo "<option value='". htmlspecialchars($quadracel_SDV['id']) ."'>" .htmlspecialchars($quadracel_SDV['name']) .' ' .'('.htmlspecialchars($quadracel_SDV['funding_source']).')' ."</option>" ;
                    }

                    $groupID = mysqli_real_escape_string($con, $_SESSION['groupID']); $sql = "SELECT * FROM inventory WHERE groupID='$groupID' AND name='DTaP/IPV - Quadracel Single Dose Syringes' ";
                    $sql_run = mysqli_query($con, $sql);
                    $quadracel_SDS = mysqli_num_rows($sql_run);
                    while ($quadracel_SDS = mysqli_fetch_array($sql_run))
                    {
                      echo "<option value='". htmlspecialchars($quadracel_SDS['id']) ."'>" .htmlspecialchars($quadracel_SDS['name']) .' ' .'('.htmlspecialchars($quadracel_SDS['funding_source']).')' ."</option>" ;
                    }
                  ?>
              </option>
            </select>
            <div class="row mb-2">
                <div class="col">
                  <input type="" id="add_quadracel_vaccines" name="vaccine" class="form-control form-control-sm" value="" hidden required>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col">
                  <input type="" id="add_quadracel_manu" name="manufacturer" class="form-control form-control-sm" value="" placeholder="Manufacturer" required>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col">
                  <input type="text" id="add_quadracel_lot" name="lot" class="form-control form-control-sm" value="" placeholder="Lot Number" required>
                </div>
                <div class="col">
                  <input type="text" id="add_quadracel_ndc" name="ndc" class="form-control form-control-sm" value="" placeholder="NDC" required>
                </div>
            </div>
            <?php
            ...
            <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" id="add_quadracel_exp" name="exp" class="form-control form-control-sm" value="" required>
                </div>
            </div>
            ...
            <div class="row mb-2">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="add_quadracel_funding" name="funding" class="form-control form-control-sm" onChange="add_validate_quadracel()" hidden required>
                  <select id="add_quadracel_eligibility" name="eligibility" class="form-select form-select-sm" onChange="add_validate_quadracel()" required>
                    <option></option>
            ...
            <button type="submit" name="administer_quadracel" class="focus-ring btn btn-sm border mt-3">Submit</button>
          </form>
        </div>
      </div>
    </div>
...
<script>
 function randomNumber(len) {
  ...
  document.getElementById("quadracel_uniqueID").value = randomNumber(8);
</script>
