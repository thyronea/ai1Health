          ...
          <form class="" action="" method="post">
            ...
            <div class="row mb-2">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="add_hpv_funding" name="funding" class="form-control form-control-sm" onChange="add_validate_hpv()" hidden required>
                  <select id="add_hpv_eligibility" name="eligibility" class="form-select form-select-sm" onChange="add_validate_hpv()" required>
                    <option></option>
