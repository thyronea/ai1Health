          ...
          <form class="" action="" method="post">
            ...
            <div class="row mb-2">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="add_covid_funding" name="funding" class="form-control form-control-sm" onChange="add_validate_covid()" hidden required>
                  <select id="add_covid_eligibility" name="eligibility" class="form-select form-select-sm" onChange="add_validate_covid()" required>
                    <option></option>
