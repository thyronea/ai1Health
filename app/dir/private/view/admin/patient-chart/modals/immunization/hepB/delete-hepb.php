      ...
      <div class="modal-body mt-3">
        <div class="col-md-12">
          <form class="" action="" method="post">
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="uniqueID" id="delete_hepB_uniqueID" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="vaccine" id="delete_hepB_name" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="lot" id="delete_hepB_lot" required>
