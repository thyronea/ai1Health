<div class="modal fade" id="delete_var" tabindex="-1" aria-labelledby="delete_varLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="delete_varLabel">Varicella</h1>
      ...
      <div class="modal-body mt-3">
        <div class="col-md-12">
          <form class="" action="" method="post">
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="uniqueID" id="delete_var_uniqueID" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="vaccine" id="delete_var_name" required>
            
            <p align="center">Administered Varicella vaccine will be permanently removed from the immunization chart.</p>
            <p>Do you still want to proceed?</p>

            <a type="button" class="focus-ring btn btn-sm border mt-3" id="submit_btn" data-bs-toggle="modal" data-bs-target="#edit_administered_var">No</a>  
