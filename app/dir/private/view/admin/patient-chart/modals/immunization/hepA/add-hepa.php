      ...
      <div class="modal-body">
        <div class="col-md-12">
          <form class="" action="" method="post">
            ...
            <div class="row mb-2">
                <div class="col">
                  <input type="" id="add_hepa_manu" name="manufacturer" class="form-control form-control-sm" value="" placeholder="Manufacturer" required>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col">
            ...
            <div class="row mb-2">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="add_hepa_funding" name="funding" class="form-control form-control-sm" onChange="add_validate_hepa()" hidden required>
                  <select id="add_hepa_eligibility" name="eligibility" class="form-select form-select-sm" onChange="add_validate_hepa()" required>
                    <option></option>
