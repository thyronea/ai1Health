      ...
      <div class="modal-body">
        <div class="col-md-12">
          <form class="" action="" method="post">
            ...
            <select id="edit_rsv_vaccines" name="id" class="form-select form-select-sm mb-4" onchange="edit_rsv()">
            ...
            <div class="row mb-2">
             ...
             <div class="row mb-2">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="edit_rsv_funding" name="funding" class="form-control form-control-sm" onChange="edit_validate_rsv()" hidden required>
                  <select id="edit_rsv_eligibility" name="eligibility" class="form-select form-select-sm" onChange="edit_validate_rsv()">
