      ...
      <div class="modal-body">
        <div class="col-md-8">
          <form class="" action="" method="post">
            ...
            <div class="row">
              <div class="col">
                <select class="form-select form-select-sm mt-2" name="state" required>
                  <option class="dropdown-item" value="<?=htmlspecialchars(decryptthis($address['state'], $key));?>" selected><?=htmlspecialchars(decryptthis($address['state'], $key));?></option>
            ...
            <button type="submit" name="patient_addressbtn" class="focus-ring btn btn-sm border mt-5">Save</button>
          </form>
        </div>
      </div>
    </div>
