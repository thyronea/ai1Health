      ...
      <div class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Patients" class="nav-item" role="presentation">
            <a class="nav-link" <a style="color: black; text-decoration: none;" href="../patients/index.php">
          ...
          <li data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Storage & Handling" class="nav-item" role="presentation">
            <a class="nav-link active" style="color: black; text-decoration: none;" href="../temperature/index.php">
