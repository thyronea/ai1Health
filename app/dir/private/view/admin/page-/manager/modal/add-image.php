<!-- Modal -->
<div class="modal fade" id="addimage" tabindex="-1" data-bs-backdrop="static" aria-labelledby="activityclear-ModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group mb-2">
          ...
          <form class="" action="process/upload-image.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mt-4 mb-3" align="center">
              ...
              <button type="submit" name="upload_image" class="focus-ring btn btn-outline-secondary btn-sm">Upload</button>
            </div>
          </form>
        </div>
      </div>
