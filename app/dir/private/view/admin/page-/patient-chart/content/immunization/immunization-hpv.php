<div class="tab-pane fade" id="hpv" role="tabpanel" tabindex="0">
    <div class="d-flex align-items-start row">
                    ...
                    <?php
                        ...
                        if($searchnum > 0)
                        {
                            ...
                            {   
                                ...
                                $admin_hpv = (date('m', strtotime($admin_date)) . '/' . date('d', strtotime($admin_date)) . '/' . date('Y', strtotime($admin_date))); 
                                ...
                                <tr align="center">
                                    ...
                                    <td >
                                        <a class="text-decoration-none focus-ring edit_hpv_btn" style="color: black; font-size: 14px" data-bs-toggle="modal" data-bs-target="#edit_administered_hpv">
                                            <div class="card shadow" id="admin_card">
                                                <div class="card-body">
                                                    <small><?=htmlspecialchars($admin_hpv);?></small>
                                                </div>
                                            </div>
                                        </a>
                                    </td>
        ...
        <div class="row col-md-10 mt-2 mb-3">
            <div class="">
                <p>HPV <a href="https://www.cdc.gov/vaccines/hcp/vis/vis-statements/hpv.pdf" target="_blank" class="text-decoration-none text-secondary"><small>(Human Papillomavirus)</small></a> - 2 Dose Series</p>
