<div class="tab-pane fade" id="mcv" role="tabpanel" tabindex="0">
    <div class="d-flex align-items-start row">
                    ...
                    <?php
                        ...
                        if($searchnum > 0)
                        {
                            ...
                            {   
                                ...
                                $admin_mcv = (date('m', strtotime($admin_date)) . '/' . date('d', strtotime($admin_date)) . '/' . date('Y', strtotime($admin_date))); 
                                ...
                                <tr align="center">
                                    ...
                                    <td >
                                        <a class="text-decoration-none focus-ring edit_mcv_btn" style="color: black; font-size: 14px" data-bs-toggle="modal" data-bs-target="#edit_administered_mcv">
                                            <div class="card shadow" id="admin_card">
                                                <div class="card-body">
                                                    <small><?=htmlspecialchars($admin_mcv);?></small>
                                                </div>
                                            </div>
                                        </a>
                                    </td>
        ...
        <div class="row col-md-10 mt-2 mb-3">
            <div class="">
                <p>Meningococcal ACWY<a href="https://www.cdc.gov/vaccines/hcp/vis/vis-statements/mening.pdf" target="_blank" class="text-decoration-none text-secondary"><small>(MenACWY-CRM ≥2 mos, MenACWY-TT ≥2years)</small></a> - 2 Dose Series</p>
