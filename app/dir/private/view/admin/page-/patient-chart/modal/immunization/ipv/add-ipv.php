...
<div class="modal fade" id="administer_ipv" tabindex="-1" aria-labelledby="administer_ipvbLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="administer_ipvbLabel">Administer IPV</h1>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <form class="" action="process/immunization/administer-vax.php" method="post">
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="uniqueID" id="ipv_uniqueID" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="type" value="IPV" required>
            ...
            <select id="ipv_ID" name="id" class="form-select form-select-sm mb-2" onchange="add_ipv()" required>
                  <option></option>
            ...
            <div class="row mb-2">
                <div class="col">
                  <input type="" id="add_ipv_vaccines" name="vaccine" class="form-control form-control-sm" value="" hidden required>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col">
                  <input type="" id="add_ipv_manu" name="manufacturer" class="form-control form-control-sm" value="" placeholder="Manufacturer" required>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col">
                  <input type="text" id="add_ipv_lot" name="lot" class="form-control form-control-sm" value="" placeholder="Lot Number" required>
                </div>
                <div class="col">
                  <input type="text" id="add_ipv_ndc" name="ndc" class="form-control form-control-sm" value="" placeholder="NDC" required>
                </div>
            </div>
            <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" id="add_ipv_exp" name="exp" class="form-control form-control-sm" value="" required>
                </div>
            </div>
            ...
            <div class="row mb-2">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" name="vis" class="form-control form-control-sm" value="<?php echo $ipv_vis; ?>" required>
                </div>
              </div>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="add_ipv_funding" name="add_ipv_funding" class="form-control form-control-sm" onChange="add_validate_ipv()" hidden required>
                  <select id="add_ipv_eligibility" name="add_ipv_eligibility" class="form-select form-select-sm" onChange="add_validate_ipv()" required>
                    <option></option>
            ...
            <button type="submit" name="administer_ipv" class="focus-ring btn btn-sm border mt-3">Submit</button>
          </form>
        </div>
      </div>
    </div>
...
<script>
 function randomNumber(len) {
  ...
  document.getElementById("ipv_uniqueID").value = randomNumber(8);
</script>
