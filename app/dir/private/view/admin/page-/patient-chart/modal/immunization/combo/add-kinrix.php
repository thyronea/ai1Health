          ...
          <form class="" action="process/immunization/administer-vax.php" method="post">
            ...
            <div class="row mb-2">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="add_kinrix_funding" name="add_kinrix_funding" class="form-control form-control-sm" onChange="add_validate_kinrix()" hidden required>
                  <select id="add_kinrix_eligibility" name="add_kinrix_eligibility" class="form-select form-select-sm" onChange="add_validate_kinrix()" required>
                    <option></option>
