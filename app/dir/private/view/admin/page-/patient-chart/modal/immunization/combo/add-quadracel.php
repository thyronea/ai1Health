          ...
          <form class="" action="process/immunization/administer-vax.php" method="post">
            ...
            <div class="row mb-2">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="add_quadracel_funding" name="add_quadracel_funding" class="form-control form-control-sm" onChange="add_validate_quadracel()" hidden required>
                  <select id="add_quadracel_eligibility" name="add_quadracel_eligibility" class="form-select form-select-sm" onChange="add_validate_quadracel()" required>
                    <option></option>
