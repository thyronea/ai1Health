<?php 
$flu_vis = date('2023') . '-' . date('10') . '-' . date('19'); 
?>

<div class="modal fade" id="administer_flu" tabindex="-1" aria-labelledby="administer_flubLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="administer_flubLabel">Administer Influenza Vaccine</h1>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <form class="" action="process/immunization/administer-vax.php" method="post">
            ...
            <input type="hidden" class="form-control form-control-sm mt-2" name="uniqueID" id="flu_uniqueID" required>
            <input type="hidden" class="form-control form-control-sm mt-2" name="type" value="Influenza" required>
            ...
            <select id="flu_ID" name="id" class="form-select form-select-sm mb-2" onchange="add_flu()" required>
                  <option></option>
            ...
            <div class="row mb-2">
                <div class="col">
                  <input type="" id="add_flu_vaccines" name="vaccine" class="form-control form-control-sm" value="" hidden required>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col">
                  <input type="" id="add_flu_manu" name="manufacturer" class="form-control form-control-sm" value="" placeholder="Manufacturer" required>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col">
                  <input type="text" id="add_flu_lot" name="lot" class="form-control form-control-sm" value="" placeholder="Lot Number" required>
                </div>
                <div class="col">
                  <input type="text" id="add_flu_ndc" name="ndc" class="form-control form-control-sm" value="" placeholder="NDC" required>
                </div>
            </div>
            <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" id="add_flu_exp" name="exp" class="form-control form-control-sm" value="" required>
                </div>
            </div>
            ...
            <div class="row mb-2">
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input type="date" name="vis" class="form-control form-control-sm" value="<?php echo $flu_vis; ?>" required>
                </div>
              </div>
              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  <input id="add_flu_funding" name="add_flu_funding" class="form-control form-control-sm" onChange="add_validate_flu()" hidden required>
                  <select id="add_flu_eligibility" name="add_flu_eligibility" class="form-select form-select-sm" onChange="add_validate_flu()" required>
                    <option></option>
            ...
            <button type="submit" name="administer_flu" class="focus-ring btn btn-sm border mt-3">Submit</button>
          </form>
        </div>
      </div>
    </div>
...
<script>
 function randomNumber(len) {
  ...
  document.getElementById("flu_uniqueID").value = randomNumber(8);
</script>
