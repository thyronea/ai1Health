        ...
        <div class="card">
         <div class="card-body shadow" align="center">
           <form method="post">
             ...
             <div class="mt-2">
               <small><a class="text-decoration-none" href="/public/view/access/">Resend Verification Code</a></small><br>
               <small><a class="text-decoration-none" href="/public/view//forgot-pw/">Reset Password</a></small>
             </div>
           </form>
         </div>
        </div>
