...
<div class="col-auto px-0">
  <div id="sidebar" class="collapse collapse-horizontal border-none"> <!-- ADD "show" TO DISPLAY AT REFRESH-->
    <div id="sidebar-nav" class="list-group border-0 rounded-0">
      ...
      <!-- Add Modal -->
      <button title="Add Document" type="button" class="nav-link focus-ring py-1 px-2 text-decoration-none border-none mt-3 mb-2" data-bs-toggle="modal" data-bs-target="#add-doc" style="text-align: left">
